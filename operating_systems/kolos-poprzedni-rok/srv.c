...
int main(void){
 ...
 //utwórz kolejkę oczekujacych równa 10
 //...
 ...
 while (1){
  dlugosc = sizeof cli;
  //czekaj na przychodzace połaczenie; gdy przyjdzie przypisz mu 'gniazdo2'
  //...
  int gniazdo2 = accept(gniazdo, (struct sockaddr*)&cli, &dlugosc);
