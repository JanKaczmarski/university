...
inline constexpr Person_PhoneType Person_PhoneType_PhoneType_MAX =
    static_cast<Person_PhoneType>(2);
[[nodiscard]] inline bool Person_PhoneType_IsValid(int value) {
  return 0 <= value && value <= 2;
}
inline constexpr int Person_PhoneType_PhoneType_ARRAYSIZE = 2 + 1;
...
[[nodiscard]] inline const ::std::string& Person_PhoneType_Name(Person_PhoneType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<Person_PhoneType_descriptor, 0, 2>(
...
/* @@protoc_insertion_point(class_definition:tutorial.Person) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kNameFieldNumber = 1,
    kEmailFieldNumber = 3,
    kIncomePercentageFieldNumber = 4,
    kIdFieldNumber = 2,
  };
  ...
  void clear_incomepercentage() ;
  [[nodiscard]] double incomepercentage() const;
  void set_incomepercentage(double value);

  private:
  double _internal_incomepercentage() const;
  void _internal_set_incomepercentage(double value);
...
// double incomePercentage = 4;
inline void Person::clear_incomepercentage() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.incomepercentage_ = 0;
  ClearHasBit(_impl_._has_bits_[0],
                  0x00000008U);
}
inline double Person::incomepercentage() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.incomePercentage)
  return _internal_incomepercentage();
}
inline void Person::set_incomepercentage(double value) {
  _internal_set_incomepercentage(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000008U);
  // @@protoc_insertion_point(field_set:tutorial.Person.incomePercentage)
}
inline double Person::_internal_incomepercentage() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.incomepercentage_;
}
inline void Person::_internal_set_incomepercentage(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.incomepercentage_ = value;
}
